...
e_bg("bgColorShadow","bgTextureShadow","bgImgOpacityShadow")?> opacity: .<?php echo $themes["opacityShadow"]?>;filter:Alpha(Opacity=<?php echo $themes["opacityShadow"]?>); -moz-border-radius: <?php echo $themes["cornerRadiusShadow"]?>; -webkit-border-radius: <?php echo $themes["cornerRadiusShadow"]?>; }
