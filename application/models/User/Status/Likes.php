 ...
 *
 * @since       Friday, June 19, 2015, 21:15 GMT+1 mknox
 * @edited      $Date$ $Author$
 * @version     $Id$
 * 
 * @category    Models
...
class User_Status_Likes extends Db
{
	// START OF THIS CLASS	
	
	public function __construct()
	{
	    $this->tableName = DB_TABLE_PREFIX.'user_status_likes';
	...
	*/
	...
	public function fetchAllLikesByParentUUID( $uuid )
	{
	...
	public function fetchLikeByUserId( $uuid, $user_uuid )
	{
	...
	public function unLikeByParentUUID( $uuid )
	{
	...
	public function removeAllLikesByParentUUID( $uuid )
	{
	    $sql    = "DELETE FROM `".mysqli_real_escape_string( $this->db, $this->tableName )."` ";
	    $sql   .= "WHERE `parent_uuid` = '".mysqli_real_escape_string( $this->db, $uuid )."' ";
